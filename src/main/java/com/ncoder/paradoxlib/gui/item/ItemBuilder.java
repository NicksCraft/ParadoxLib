 ...
 *
 * <p>
 * In future, this class will be removed and replaced with
 * {@link ItemBuilderBase}. Presently, this class exists for
 * backwards-compatibility, so that previous consumers of the
 * {@link ItemBuilder} API (who would have initialized an
 * ItemBuilder with a constructor) can have a phased move to using the static
...
public final class ItemBuilder implements ItemBuilderBase {
     ...
     *
     * <p>
     * This method is deprecated and will be replaced with
     * {@link ItemBuilder#create(Material)}. The ultimate goal is
     * to replace the {@link ItemBuilder} class with the {@link ItemBuilderBase}
     * interface.
     *
     * @throws IllegalArgumentException if the material is a non-item type.
     * @param material type of stack to create a builder for.
     * @deprecated use {@link ItemBuilder#create(Material)} as this method is to be
     *             replaced with static factory method
     *             - see above.
     */
    @Deprecated()
    ...
    /**
     * Create a new {@link ItemBuilder} that uses the provided {@link ItemStack} and
     * associated metadata as the initial
     * configuration.
     *
     * <p>
     * This method is deprecated and will be replaced with
     * {@link ItemBuilder#from(ItemStack)}. The ultimate goal is
     * to replace the {@link ItemBuilder} class with the {@link ItemBuilderBase}
     * interface.
     *
     ...
     * @deprecated use {@link ItemBuilder#from(ItemStack)} as this method is to be
     *             replaced with static factory method -
     *             see above.
     */
    @Deprecated()
    ...
    @Nonnull
    @Override
    public ItemBuilder color(@Nonnull ColorType color) {
        builder.color(color);
        return this;
    }
