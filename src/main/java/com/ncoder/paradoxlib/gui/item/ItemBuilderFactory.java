 ...
 *
 * <p>
 * This factory is used to auto-register {@link ItemBuilderConstructors} for a
 * compatible {@link ItemBuilderBase}
 * depending on which server API version GUIMenu is targeting.
 */
public final class ItemBuilderFactory implements ItemBuilderConstructors {
    ...
    static {
        ...
        // This is the entry point for the ItemBuilder, so there's a chance this will be
        // invoked before the factory
        // would have been initialized with the static initializer (causing a
     ...
     *
     * @return true if constructors have already been registered (implying new ones
     *         will be ignored).
     */
     ...
     *
     * <p>
     * This can be used to dynamically set the {@link ItemBuilderBase}
     * implementation at runtime depending on (e.g.,
     * API versions).
     *
