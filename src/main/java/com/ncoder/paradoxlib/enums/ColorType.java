...
/**
 * Items such as glass panes can have variable color. Historically, Minecraft
 * (and the Bukkit/Spigot APIs) represented
 * these colors with data/durability values.
 *
 * <p>
 * This version of the item color tool is designed to have an API that will
 * allow identifying color types across
...
public enum ColorType {
    ...
    MAGENTA,
    /**
     * <img height="64" width="64" src="colors/light_blue_wool.png" alt="Light blue
     * wool">
     */
    LIGHT_BLUE,
    /**
    ...
    GRAY,
    /**
     * <img height="64" width="64" src="colors/light_gray_wool.png" alt="Light gray
     * wool">
     */
    LIGHT_GRAY,
